...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/CIFAR--10-Dataset-blue?style=for-the-badge" alt="CIFAR-10"/>
  <img src="https://img.shields.io/badge/Open%20in-Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white" alt="Colab"/>
</p>

> A complete **Convolutional Neural Network (CNN)** image-classification pipeline built **from scratch** with **PyTorch**.

The model is trained on the **CIFAR-10 dataset** and evaluated on two fronts:
- the standard CIFAR-10 **test set**, and
- **real-world smartphone images**, to analyze generalization under domain shift.

The notebook is fully automated — just click **Run All** in Google Colab.
...
- [Evaluation on CIFAR-10 Test Set](#evaluation-on-cifar-10-test-set)
- [Real-World Smartphone Image Predictions](#real-world-smartphone-image-predictions)
...
```
210104_CNN_Vehicles_-_Animals_CIFAR-10/
├── dataset/          # Real-world smartphone images (test samples)
├── model/
│   └── 210104.pth    # Saved model checkpoint
├── 210104.ipynb      # Main notebook (train + evaluate)
└── README.md
```
...
1. Open the notebook in Google Colab:  
  https://colab.research.google.com/github/tarshibofficial/CNN-Vehicles-Animals-CIFAR10/blob/main/210104_CNN_Vehicles_-_Animals_CIFAR-10-main/210104_CNN_Vehicles_-_Animals_CIFAR-10-main/210104.ipynb	
